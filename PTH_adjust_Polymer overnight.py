...
# read the FIRM FLAT positions from some place!
    firm_positions_file_path=r"//paghk.local/Polymer/HK/Department/All/Enfusion/Polymer/"+today1
...
firm_positions_file_path1=r"//paghk.local/Polymer/HK/Department/All/Enfusion/Polymer/"+today1
...
writer1 = pd.ExcelWriter(r"T:\Daily trades\Daily Re\PTH Adjustment\PTH_ADJUSTovernight.xlsx", engine='xlsxwriter')
