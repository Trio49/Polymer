...
net=net[["strats",
         ...
         "Position",
            ...
            "Deal Id",
            "Instrument Id"]]
net.to_csv(r"P:\Operations\Polymer - Middle Office\PTH and FX booking\PTH unwind/"+today+"_PTH_Unwind"+".csv",index=False)
...
writer1 = pd.ExcelWriter(r"P:\Operations\Polymer - Middle Office\PTH and FX booking\PTH_ADJUST1.xlsx", engine='xlsxwriter')
...
workbook = load_workbook(filename=r"P:\Operations\Polymer - Middle Office\PTH and FX booking/PTH_ADJUST1.xlsx")
...
workbook.save(filename=r"P:\Operations\Polymer - Middle Office\PTH and FX booking/PTH_ADJUST1.xlsx")
workbook.close()

#load the unwind csv file dataframe and save the columns
unwind=pd.read_csv(r"P:\Operations\Polymer - Middle Office\PTH and FX booking\PTH_Unwind.csv")
