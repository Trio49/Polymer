...
if check == 'yes':
    poly_fin.to_csv(r"P:\All\FinanceTradingMO\Rebate_Borrow breakdwon\outputdata.csv", index=False,
                    line_terminator='\n')
    ...
    MTD_PB_Swap.to_csv(r"P:\All\FinanceTradingMO\Rebate_Borrow breakdwon\MTD_PB_Swap_PTH" + month + ".csv", index=False,
                       line_terminator='\n')
    MTD_PM_Swap.to_csv(r"P:\All\FinanceTradingMO\Rebate_Borrow breakdwon\MTD_PM_Swap_PTH" + month + ".csv", index=False,
                       line_terminator='\n')
    MTD_PB_Cash.to_csv(r"P:\All\FinanceTradingMO\Rebate_Borrow breakdwon\MTD_PB_Cash_PTH" + month + ".csv", index=False,
                       line_terminator='\n')
    MTD_PM_Cash.to_csv(r"P:\All\FinanceTradingMO\Rebate_Borrow breakdwon\MTD_PM_Cash_PTH" + month + ".csv", index=False,
                       line_terminator='\n')
    print('Saved')

    with pd.ExcelWriter(r"P:\All\FinanceTradingMO\Rebate_Borrow breakdwon\202304_PTH_Financing.xlsx") as writer:
