...
if combine == "yes":
    os.chdir(r"P:\Operations\Polymer - Middle Office\Borrow analysis\Tora data output")
    extension = 'csv'
...
df = pd.read_csv(r"P:\Operations\Polymer - Middle Office\Borrow analysis\Tora data output/combined_csv.csv",
                 engine='python')
