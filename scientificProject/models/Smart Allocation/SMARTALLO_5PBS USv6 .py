...
if combine =='yes':
    for file_name in Tora_file_path_list1:   
        if "POLYMER_EOD_815" in file_name:
            print(file_name)
    ...
    for file_name in Tora_file_path_list1:   
        if "POLYMER_BORROW_815" in file_name:
            print(file_name)
    ...
    if merge_file=='1':
        merged.to_excel(r"P:\Operations\Polymer - Middle Office\Smart Allocation\SmartAllo\SmartAllocationUStrade.xlsx", sheet_name="trades")
        merged2.to_excel(r"P:\Operations\Polymer - Middle Office\Smart Allocation\SmartAllo\SmartAllocationUSborrow.xlsx", sheet_name="borrows")

#loading
raw_trades= pd.read_excel(r"P:\Operations\Polymer - Middle Office\Smart Allocation\SmartAllo\SmartAllocationUStrade.xlsx",sheet_name="trades")
...
raw_trades=raw_trades[raw_trades["Last Execution Date"]!=pbd1]
#filter out swp trade
...
borrows= pd.read_excel(r"P:\Operations\Polymer - Middle Office\Smart Allocation\SmartAllo\SmartAllocationUSborrow.xlsx",sheet_name="borrows")
...
raw_trades_HTB_IMPORTANT.to_excel(r"P:\Operations\Polymer - Middle Office\Smart Allocation\SmartAllo\Smart_Allo_OutputUS.xlsx",index=False)
print("done")