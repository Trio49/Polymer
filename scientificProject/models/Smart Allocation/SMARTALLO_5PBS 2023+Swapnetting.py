...
# filter out long buy and sell short trades for eligible for swap financing
JP_Trades=raw_trades[raw_trades["CCY"].isin(["JPY"])]
JP_Trades=JP_Trades[JP_Trades["Side"].isin(["BUY","SHORT"])]

#filter out raw trades for smart allocation calculation
