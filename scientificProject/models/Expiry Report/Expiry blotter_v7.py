...
PM_enail_mapping = dict(AKUNG="akung@polymercapital.com", EDMLO="elo@polymercapital.com",
                        ...
                        SGUPT="shiv.gupta@polymercapital.com", DANBO= "dbosscher@pag.com",JUNBA="jybang@polymercapital.com"
                  )
# PM_enail_mapping = {
...
if send_email == "1":
 ...
 with pd.ExcelWriter(r"P:\Operations\Polymer - Middle Office\Python_Trade_Blotter\Expiry report\Expiry.xlsx",
    ...
    for PM in All_PM:
        ...
        text_file = open("P:\Operations\Polymer - Middle Office\Python_Trade_Blotter\Expiry report\expiry.htm", 'w')
        ...
        mail.HTMLBody = source_code + "<br><br>Thanks and Regards,<br>Zach"
