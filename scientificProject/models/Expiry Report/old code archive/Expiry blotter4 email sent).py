...
pmlist: ExtensionArray | ndarray | Series | None | DataFrame | NDFrame | Any = Expiry_Blotter_Data_allPM['PM code'].unique
...
#     "DPARK": "dpark@polymercapital.com",
#     "QIHAO": "hqin@polymercapital.com",
...
#     "KUCHI": "kmoriuchi@polymercapital.com",
#     "PANHU": "phui@polymercapital.com;teamphui@polymercapital.com",
#     "DCHIN": "dching@polymercapital.com",
#     "MELOU": "mengl@polymercapital.com",
#     "TLIAN": "tliang@polymercapital.com",
#     "LBURK": "lburke@polymercapital.com",
#     "VIHAN": "vhan@polymercapital.com",
#     "JZHAN": "johnnyz@polymercapital.com",
...
#     "PCM_XZHAN": "hsasao@pag.com",
#     "xTRADE": "awai@polymercapital.com;hho@polymercapital.com",
#     "AGINE":"agineitis@pag.com",
#     "KYAHA":"kyahata@pag.com",
#     "AFUKU":"afukushima@polymercapital.com",
#     "KNAKA":"knakamura@pag.com;tkasai@pag.com",
#     "KOKUM":"kokumoto@polymercapital.com",
#     "KMIYA":"kmiyashita@polymercapital.com",
#     "KSUZU":"ksuzuki@polymercapital.com",
#     "YINOU":"yinoue@polymercapital.com",
#     "PDRZE":"pdrzewucki@polymercapital.com",
#     "KAZUW":"kwatanabe@pag.com",
#     "SHIGN":"snaito@pag.com",
#     "SSUGI":"ssugitomo@polymercapital.com",
#     "KMOHR":"kmohri@polymercapital.com",
#     "YSUGI":"ysugiyama@polymercapital.com",
#     "YNAKA":"ynakashima@polymercapital.com",
#     "JZHUO":"jack.zhuo@polymercapital.com",
#     "TNARU":"tnarui@polymercapital.com",
#     "MSUZU":"mitsuharu.suzuki@polymercapital.com",
#     "YOKISH":"yokishio@polymercapital.com",
#     "MAMORI":"masashi.mori@polymercapital.com",
#     "HGAWA":"hhasegawa@polymercapital.com",
#     "TSHOM":"tshomura@polymercapital.com",
#     "MKITA":"mkitani@polymercapital.com",
#     "HFUJI":"hfujinaga@polymercapital.com",
...
with pd.ExcelWriter(r"T:\Daily trades\Daily Re\Python_Trade_Blotter\Expiry report\Expiry.xlsx",
    ...
    for PM in All_PM:
        ...
        # for PM in All_PM:
    #
    #     Expiry_Blotter_Data_allPM[Expiry_Blotter_Data_allPM['PM code'] == PM].to_excel(writer, sheet_name=PM, index=None)
    #
    #
    #     html = Expiry_Blotter_Data_allPM[Expiry_Blotter_Data_allPM['PM code'] == PM].to_html(index=False)
    #     text_file = open("T:\Daily trades\Daily Re\Python_Trade_Blotter\Expiry report\expiry.htm", 'w')
    ...
    #     outlook = win32.Dispatch('Outlook.Application')
    #     mail = outlook.CreateItem(0)
    #     # send email to the PM and CC to the team based on the PM email mapping
    #
    #     mail.to = PM_enail_mapping[PM]
...
# set up a schedule job to run this script every day at 9am
