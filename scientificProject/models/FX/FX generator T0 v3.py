...
if instruction=='yes':
    ...
    dfx2=dfx2[['CCY Pair', 'Product', 'Traded Currency','Direction', 'VD', 'PB', 'Account',
           'LOCAL NOTIONAL']]
    dfx2.to_excel(r'P:\Operations\Polymer-FX/fx_project\funding/'+td.strftime('%Y%m%d')+'_T0'+'fxinstruction.xlsx',sheet_name='Instruction',index=False)
...
# # #save file
fxt0_sub.to_excel(r'P:\Operations\Polymer-FX\fx_project\funding/'+td.strftime('%Y%m%d')+'_T0'+'fx.xlsx',sheet_name='Uploader',index=False)
